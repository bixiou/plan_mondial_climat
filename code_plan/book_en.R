...
# Figure 1.1 ../figures/policies/GDP_pc_PPP.pdf
...
# The Figures of this Chapter are from Fabre, Douenne & Mattauch (2023).
# Figure 4.1 ../figures/OECD/Heatplot_global_tax_attitudes_share.pdf
# Figure 4.2 ../figures/country_comparison/gcs_support_positive.pdf
# Figure 4.3 ../figures/country_comparison/conjoint_left_ag_b_binary_positive.pdf
...
## 5.1
# Figure 5.1 ../figures/policies/emissions_per_region_sm.pdf
...
legend("topright", legend = c("World", "China", "United States", "European Union", "India", "Sub-Saharan Africa"), col = c("black", "red", "blue", "darkgreen", "orange", "purple"), lwd = 2, lty = 1:6)
...
# Figure 5.2 ../figures/policies/GCP_trajectories.pdf 
...
# mar <- par()$mar
# mgp <- par()$mgp
par(mar = c(3.1, 3.1, 0.3, 0.2), mgp = c(2, 1, 0)) # width: 342, height: 320
